        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                ...
                <div class="card-body border-bottom">
                    <form method="GET" action="{{ route('manager.teachers.index') }}" class="row g-3">
                        <div class="col-md-6">
                ...
                <div class="table-responsive text-nowrap">
                    @if($teachers->count() > 0)
                        <form id="bulkActionForm" method="POST" action="{{ route('manager.teachers.bulk-action') }}">
                            @csrf
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="{{ route('manager.teachers.show', $teacher) }}">
                                                            <i class="bx bx-show-alt me-1"></i> View
                                                        </a>
                                                        <a class="dropdown-item" href="{{ route('manager.teachers.edit', $teacher) }}">
                                                            <i class="bx bx-edit-alt me-1"></i> Edit
                                                        </a>
                                                        <form method="POST" action="{{ route('manager.teachers.toggle-verification', $teacher) }}" class="d-inline">
                                                            @csrf
                                                        ...
                                                        <form method="POST" action="{{ route('manager.teachers.resend-welcome-email', $teacher) }}" class="d-inline">
                                                            @csrf
                                                            <button type="submit" class="dropdown-item">
                                                        ...
                                                        <button type="button" class="dropdown-item text-danger" onclick="confirmDelete('{{ $teacher->full_name }}', '{{ route('manager.teachers.destroy', $teacher) }}')">
