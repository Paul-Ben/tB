        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                @elseif($userType === 'teacher')
                    @include('components.navigation.teacher')
                @elseif($userType === 'guardian')
                    @include('components.navigation.guardian')
                @else
                    @include('components.navigation.admin')
                @endif
            </aside>
                    ...
                    <footer class="content-footer footer bg-footer-theme">
                        <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                            <div class="mb-2 mb-md-0">
                                © {{ date('Y') }}, made with ❤️ by <a href="#" target="_blank" class="footer-link fw-bolder">{{ config('app.name') }}</a>
                            </div>
                        </div>
                    </footer>
                    <!-- / Footer -->
